...
→ KG-aware 方法**在稀疏 KG 下整體失效**，本文以此為問題切入點
...
→ **稀疏 KG 是 real-world default 而非邊緣案例**

→ 模型在 KG 不可信時的**穩健性**，比 KG 豐富時的**峰值**更具實用價值
...
## Slide 5 — Related Work: Graph-based CF — LightGCN
...
## Slide 6 — Related Work: KG-aware Recommendation — KGAT
...
## Slide 7 — Related Work: Contrastive KG Methods — KGCL & MCCLK
...
## Slide 8 — Related Work: Rationale-aware Methods — KGRec
...
→ KGRec 在 **rationale-aware** 設計線上是與本文最相關的工作，下一張比較兩者的範式分歧
...
## Slide 10 — Related Work: Dual-View / Multi-View Recommenders
...
## Slide 17 — Local View: LightGCN Propagation
...
## Slide 22 — Training Setup & Complexity
...
## Slide 26 — Methodological Insight: Attention Normalization
