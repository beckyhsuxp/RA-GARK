...
The remainder of this thesis is organized as follows. Chapter~\ref{ch:relatedwork} reviews related work along four axes: graph collaborative filtering, KG-aware recommendation, gating mechanisms in deep learning, and attention normalization. Chapter~\ref{ch:architecture} presents the overall RA-GARK architecture and formalizes the recommendation problem. Chapter~\ref{ch:methodology} details each module, including the local view, the global KG view with its two innovations (KG-SVD initialization and softmax aspect-saliency attention), the local-biased fusion gate, and the cross-view contrastive regularization. Chapter~\ref{ch:evaluation} reports experimental results, ablations, sensitivity analyses, and a case study. Chapter~\ref{ch:conclusion} discusses the methodological insight on attention normalization, acknowledges the limitations of single-dataset validation and seed sensitivity, and concludes.
