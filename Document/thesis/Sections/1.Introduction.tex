...
\begin{table}[ht]
\centering
\caption[NDCG@20 of representative KG-aware methods vs.\ pure LightGCN.]{NDCG@20 of representative KG-aware methods on our sparse review-derived KG, contrasted with pure LightGCN. All four KG-aware methods underperform the no-KG baseline.}
