...
本論文的主張是：KG 不應如 KGAT 式深度融合那般，成為評分管線中的\emph{必要組件}，而應作為一條可依其訊號是否有用而被\emph{明確閘控}的旁路通道。第~\ref{ch:methodology-zh}~章將進一步給出實際的架構與最佳化設定。
...
\begin{enumerate}
  ...
  \item \textbf{RA-GARK，一個雙視角架構}：以旁路通道而非深度融合的方式整合協同訊號與 KG 衍生訊號。第~\ref{ch:methodology-zh}~章將完整展開其架構與訓練程序。
