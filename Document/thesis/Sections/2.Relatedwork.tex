...
\begin{table}[ht]
\centering
\caption{Rationale-paradigm comparison: KGRec vs.\ RA-GARK along the four design axes.}
...
\begin{table}[ht]
\centering
\caption[Integration mechanisms used by representative KG-aware recommenders.]{Integration mechanisms used by representative KG-aware recommenders. None provide architectural graceful degradation under unreliable KG.}
...
\begin{table}[ht]
\centering
\caption[Design comparison along four axes.]{Design comparison along four axes. NDCG@20 is reported on our sparse review-derived KG benchmark.}
