...
\begin{table}[!htbp]
\centering
\caption{Rationale-paradigm comparison between KGRec and RA-GARK.}
...
\midrule
\textbf{RA-GARK} & \textbf{Pure LightGCN} & \textbf{Gated late fusion} & \textbf{Aspect softmax} & \textbf{best} \\
\bottomrule
\end{tabular}
\end{table}
\FloatBarrier
