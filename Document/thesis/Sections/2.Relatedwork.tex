...
\midrule
\textbf{RA-GARK} & \textbf{Pure LightGCN} & \textbf{Gated late fusion} & \textbf{Aspect softmax} & \textbf{0.1242} \\
\bottomrule
\end{tabular}
\end{table}
\FloatBarrier
