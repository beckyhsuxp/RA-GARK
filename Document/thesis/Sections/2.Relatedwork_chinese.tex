...
表~\ref{tab:rw-summary-zh} 從四個設計面向匯整比較，並報告在我們的稀疏評論型 KG 基準上的 NDCG@20。在此基準上所評估的方法中，RA-GARK 是唯一同時將純 LightGCN 區域聚合器與閘控後期融合的 KG 訊號相結合者，也是唯一將合理化作用於物品—aspect 粒度而非 KG 邊粒度者。
