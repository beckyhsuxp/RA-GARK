...
All experiments are run on a single NVIDIA GeForce RTX 3090 GPU with $24$\,GB of memory. The model is implemented in PyTorch~2.6.0+cu126 and trained in single-precision. Per-epoch wall-clock time is reported in Section~\ref{sec:eval-cost}.
