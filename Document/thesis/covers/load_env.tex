...
\setCJKmainfont[
  Path = /System/Library/AssetsV2/com_apple_MobileAsset_Font8/5f4c23e4a0c7b70597730d79e252955e973ead7d.asset/AssetData/,
  Index = 1,
  AutoFakeBold={4},
  AutoFakeSlant=0.2
]{BiauKai.ttc}
...
% 設定目錄的最大深度到 subsection 層級
\setcounter{tocdepth}{2}

% 控制編號的深度到 subsection 層級
\setcounter{secnumdepth}{2}

% PDF 內部超連結：目錄、引用、參考文獻可點擊跳轉
% 須最後載入，避免與其他套件衝突
