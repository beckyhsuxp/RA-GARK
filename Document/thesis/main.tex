...
\newcommand{\studentEnName}{Pei-Chih Hsu} % 書名頁
\newcommand{\studentEnNameA}{Hsu, Pei-Chih} % 封面用

% 教授的名字
\newcommand{\advisorCnName}{劉敦仁}
\newcommand{\advisorEnName}{Duen-Ren Liu}     % 書名頁
\newcommand{\advisorEnNamex}{Liu, Duen-Ren}   % 封面用
